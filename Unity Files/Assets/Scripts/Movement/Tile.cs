...
/*
 * Guide, No Jump Height Implemented, refer to this if we want to integrate jump height
 * https://www.youtube.com/watch?v=cK2wzBCh9cg&t=1554s&ab_channel=GameProgrammingAcademy
 */
...
namespace Movement
{
    public class Tile : MonoBehaviour
    {
         ...
         * If it's a valid tile to move to, adds it to an adjacency list for BFS.
         */
        ...
        /*
         * Reset all variables after every turn
         */
        public void Reset()
        {
            adjacencyList.Clear();
